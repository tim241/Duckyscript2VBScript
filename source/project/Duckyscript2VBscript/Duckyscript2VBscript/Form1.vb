...
Public Class Form1
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
         TextBox2.Text = "'This script is generated in the Duckyscript2VBScript © converter."
        ...
        TextBox2.Text = TextBox2.Text.Replace("%", "{%}")
        TextBox2.Text = TextBox2.Text.Replace("""", """""")
        TextBox2.Text = TextBox2.Text.Replace("{'}This script is generated in the Duckyscript2VBScript © converter.", "'This script is generated in the Duckyscript2VBScript © converter.")
